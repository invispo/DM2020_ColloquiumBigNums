...
public class BigPolinom
{
	...
	* (-52163/2521)x^7 + (35255)*x^6+ (732/-2612)x^5 +1524634x^4+(2623/36324)x^3 + (-51268235)x^2 +132152*x^1 + (-1513262/-15612), тут 132152*x^1 может также выглядить как 132152*x
	*
